  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        ...
        BlocProvider(create: (BuildContext context)=>sl<CategoryCubit>()..getCategories()),
        ...
        BlocProvider(create: (BuildContext context)=>sl<FavouriteCubit>()),
        ...
        BlocProvider(create: (BuildContext context)=>sl<AddressCubit>()),
